...
<div class="container bg-white px-4 py-4 border" style="width: 94%;">
    ...
    <a href="{{ BASE_URL }}/promover/{{ $product->id }}" 
    class="btn btn-primary mb-3">Promover Produto</a>
    @endif
    ...
    <div class="row">
        ...
        <div class="col-md-12 boder">
            ...
            <form enctype="multipart/form-data" action="{{ BASE_URL }}/product/update/{{ $product->id }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <?php foreach($product->images as $image): ?>
                                    <div class="col-md-3 border p-4 text-center">
                                        ...
                                        <br><a href="{{ BASE_URL }}/product/deleteimage/{{ $image->id }}" 
